...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\begin{date_section}
		\yearrange{2018}{2019} Visiting Assistant Professor, University of California, Irvine % July 2018 - July 2019

		\yearrange{2018}{2018} Lecturer, University of Washington % June 2018 - August 2018

		%\yearrange{2013}{2018} Teaching Assistant, University of Washington % September 2013 - June 2018
	\end{date_section}
...
%			Liberty High School, Hillsboro OR
	...
	\item S. Arpin, C. Camacho-Navarro, K. Lauter, J. Lim, K. Nelson, T. Scholl, J. Sotáková. Adventures in Supersingularland. \emph{Experimental Mathematics}. Published October 2021. Available at \url{https://doi.org/10.1080/10586458.2021.1926009}.

	\item S. Marseglia, T. Scholl. Products and polarizations of super-isolated abelian varieties. \emph{Mathematische Zeitschrift}. Published June 2021. Available at \url{https://doi.org/10.1007/s00209-021-02791-x}

\item Eric Rains, Karl Rubin, Travis Scholl, Shahed Sharif, Alice Silverberg. Algebraic maps constant on isomorphism classes of unpolarized abelian varieties are constant. \emph{Algebra Number Theory}. Published June 2021. Available at \url{https://doi.org/10.2140/ant.2021.15.711}

	\item T. Scholl. Super-Isolated Abelian Varieties. \emph{Journal of Number Theory}. Published January 2020. Available at \url{https://doi.org/10.1016/j.jnt.2019.06.008}.

	\item T. Scholl. Abelian Varieties with Small Isogeny Class and Applications to Cryptography. \emph{PhD Thesis, University of Washington}. Published July 2018. Available at \url{http://hdl.handle.net/1773/42458}.

	\item T. Scholl. Super-Isolated Elliptic Curves and Abelian Surfaces in Cryptography. \emph{Experimental Mathematics}. Published January 2018. Available at \url{https://doi.org/10.1080/10586458.2017.1412371}.

	\item T. Scholl. Isolated elliptic curves and the MOV attack. \emph{Journal of Mathematical Cryptology}. Published May 2017. Available at \url{https://doi.org/10.1515/jmc-2016-0053}.
...
%		General University Scholarship, University of Oregon
	...
	\begin{date_section}
		...
		\yearmo{2021}{Jan.} % Jan 9 2021
		AMS special session on Mathematics of Cryptography
		Join Math Meetings,
		Online
%		Products and Polarizations of Super-Isolated Abelian Varieties

		\yearmo{2020}{Jan.} % Jan 18 2020
		Special Section on Arithmetic Galois Actions,
		Join Math Meetings,
		Denver, CO
%		Super-Isolated Curves

		\yearmo{2019}{Aug.} % Aug 20 2019
		Rump Session,
		Crypto 2019
% 	48ce563f89a0ed9414f5aa28ad0d96d6795f9c62

		\yearmo{2019}{May.} % May 30 2019
		Number Theory Seminar,
		University of Maryland
% 	Isolated Curves in Cryptography

		\yearmo{2019}{Mar.} % Mar 23 2019
...
%		Isolated Curves in Cryptography
		...
		\yearmo{2019}{Mar.} % Mar 22 2019
		AMS Special Session on Cryptography,
		University of Hawai'i at M{\=a}noa
%		Special Session on Arithmetic Geometry and Its Connections
%		Isolated Curves in Cryptography

%		\yearmo{2019}{Jan.} % Jan 11 2018
%		Multilinear Map Seminar,
%		University of California Irvine
%		Cryptographic Applications of the Weil Pairing

%		\yearmo{2018}{Nov.} % Nov 20 2018
%		Multilinear Map Seminar,
%		University of California Irvine
%		An Introduction to Cryptographic Multilinear Maps

		\yearmo{2018}{Oct.} % Oct 19 2018
		Number Theory Seminar,
		University of California Los Angeles
%		Isolated Elliptic Curves in Cryptography

		\yearmo{2018}{Oct.} % Oct 11 2018
		Number Theory Seminar,
		University of California Irvine
%		Abelian Varieties with Small Isogeny Classes

		\yearmo{2018}{Oct.} % Oct 9 2018
		Cryptography Seminar,
		University of California Irvine
%		Isolated Abelian Varities in Cryptography

		\yearmo{2018}{Jun.} % June 19,21 2018
...
%	\end{date_section}
	...
	\begin{date_section}
		\yearrange{2018}{cur.} % Nov. 2018 - (current)
	...
	\begin{date_section}
		\yearmo{2019}{Jun.} % June 10-14, 2019
	...
	\begin{date_section}
		\yearmo{2020}{Jan.} % Jan 14-18, 2020
		\emph{Join Math Meetings}, Denver, CO

		\yearmo{2019}{Mar.} % March 21-23, 2019
		\emph{AMS Sectional Meeting}, Honolulu, HI

		\yearmo{2019}{Jan.} % January 16-19, 2019
		\emph{Joint Math Meetings}, Baltimore, MD

		\yearmo{2018}{Sep.} % September 17-21, 2018
		\emph{Open Questions in Cryptography and Number Theory}, Irvine, CA

		\yearmo{2018}{Aug.} % August 1-4, 2018
		\emph{MAA MathFest},
		Denver, CO

		\yearmo{2018}{Jul.} % July 16-20, 2018
		\emph{Algorithmic Number Theory Symposium XIII},
		Madison, WI

		\yearmo{2018}{Jun.} % June 18-22, 2018
		\emph{Communicating Mathematics Effectively},
		Seattle, WA

		\yearmo{2018}{Apr.} % April 20, 2018
		\emph{PNW MAA Section Meeting},
		Seattle, WA
		% Helped run Sagee minicourse
...
%		\end{date_section}
	...
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
		...
		\begin{date_section}
			...
			\yearrange{2019}{2019} % Spring 2019
				Math Circle Leader,
				University California, Irvine,
				Irvine CA
				%\\ leading elementary school kids in a math circle


			\yearrange{2018}{2018} % Summer 2018
				Tutor,
				Ada Developers Academy,
				Seattle WA
				%\\ helping women and underrepresented minorities learn to code

			%\yearrange{2018}{2018} % Apr. 17th 2018
			%	Elementary School Math Teacher Circle,
			%	University of Washington
			%	%\\ talking to elementary school math teachers
...
%				Cottage Grove, OR
	...
	\begin{date_section}
		\yearrange{2018}{2018} Software Engineer, \url{www.cocalc.com} % May 2018 - August 2018
