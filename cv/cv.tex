...
%		\end{enumerate}
	...
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
		...
		\begin{date_section}
			...
			\yearmo{2016}{-2017} % Spring 2016, Fall 2016, Winter 2017
				Mentor,
				WXML,
				University of Washington
...
%					Cottage Grove, OR
	...
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        written in Sage, Python, and Go; as well as front end projects written using Typescript/Javascript, HTML, and SASS/CSS.
