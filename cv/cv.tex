...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
		...
		\begin{date_section}
			...
			% 2013-
				\item[
			{\hspace*{-5ex}\makebox[3ex][l]{2018 (expected)}}
			]  \hspace*{2ex} Ph.D. Mathematics, University of Washington, Seattle WA (advisor: Neal Koblitz)
...
%			Liberty High School, Hillsboro OR
	...
	\begin{date_section}
		...
		Math 125: Calculus II, Summer Instructor % MATH 125 Calculus with Analytic Geometry II
